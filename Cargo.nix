  ...
  internal = rec {
    ...
    crates = {
      ...
      "opentelemetry-http" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "internal-logs" "reqwest" "reqwest-rustls-webpki-roots" "tracing" ];
      };
      "opentelemetry-otlp" = rec {
        ...
        resolvedDefaultFeatures = [ "http" "http-proto" "metrics" "opentelemetry-http" "prost" "reqwest" "reqwest-client" "reqwest-rustls-webpki-roots" "trace" ];
      };
      "opentelemetry-proto" = rec {
        ...
        resolvedDefaultFeatures = [ "gen-tonic-messages" "metrics" "prost" "tonic" "trace" ];
      };
      "opentelemetry_sdk" = rec {
        ...
        resolvedDefaultFeatures = [ "async-trait" "experimental_async_runtime" "glob" "metrics" "percent-encoding" "rand" "rt-tokio" "tokio" "tokio-stream" "trace" ];
      };
      "parking_lot" = rec {
      ...
      "pleme-observability" = rec {
        crateName = "pleme-observability";
        version = "0.3.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./.; };
        libName = "pleme_observability";
        dependencies = [
          {
            name = "opentelemetry";
            packageId = "opentelemetry";
          ...
          }
          {
            ...
            optional = true;
            usesDefaultFeatures = false;
            features = [ "http-proto" "reqwest-client" "reqwest-rustls-webpki-roots" "trace" ];
          }
          {
            name = "opentelemetry_sdk";
            packageId = "opentelemetry_sdk";
        ...
        features = {
          "default" = [ "tracing-basic" "metrics" ];
          "distributed-tracing" = [ "tracing-opentelemetry" "opentelemetry" "opentelemetry_sdk" "opentelemetry-otlp" ];
          "full" = [ "tracing-basic" "distributed-tracing" "metrics" ];
        ...
        resolvedDefaultFeatures = [ "default" "distributed-tracing" "full" "metrics" "opentelemetry" "opentelemetry-otlp" "opentelemetry_sdk" "tracing-basic" "tracing-opentelemetry" ];
      };
      "potential_utf" = rec {
      ...
      "rand 0.8.5" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "getrandom" "libc" "rand_chacha" "small_rng" "std" "std_rng" ];
      };
      "rand 0.9.2" = rec {
        crateName = "rand";
        version = "0.9.2";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "blocking" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.14";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "io-util" "libc" "mio" "net" "rt" "rt-multi-thread" "socket2" "sync" "test-util" "time" "windows-sys" ];
      };
      "tokio-rustls" = rec {
      ...
      "tonic" = rec {
        ...
        resolvedDefaultFeatures = [ "codegen" "prost" ];
      };
      "tower" = rec {
        crateName = "tower";
        version = "0.5.3";
